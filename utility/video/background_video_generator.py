...
def generate_video_url(timed_video_searches, video_server, total_duration):
    timed_video_urls = []
            ...
            for (t1, t2), search_terms in timed_video_searches:
                ...
                for query in search_terms:
                    ...
                    if url:
                        ...
                        break
                duration = min(15, total_duration - current_time)  # Max 15 seconds per clip
                timed_video_urls.append([[current_time, current_time + duration], url])
